...
export default function Footer() {
  return (
    <footer className="relative z-50 px-4 pb-3">
      <div className="mx-auto w-full max-w-6xl rounded-2xl border border-slate-200 bg-white/88 px-5 py-4 shadow-[0_12px_32px_rgba(15,23,42,0.06)] backdrop-blur-sm">
            ...
            {SOCIAL_LINKS.map((item) => {
              ...
              return (
                <Link
                  ...
                  className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-slate-200 bg-white text-slate-600 transition-colors hover:bg-slate-50 hover:text-slate-900"
                >
