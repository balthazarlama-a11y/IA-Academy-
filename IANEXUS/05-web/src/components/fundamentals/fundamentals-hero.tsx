...
export default function FundamentalsHero({ postsCount, toolsCount }: FundamentalsHeroProps) {
  return (
    <section className="overflow-hidden rounded-[32px] border border-slate-200/80 bg-white p-6 shadow-[0_18px_60px_rgba(15,23,42,0.08)] md:p-8">
      <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
        ...
        <div className="grid gap-3 sm:grid-cols-3 lg:grid-cols-1">
          <div className="rounded-[24px] border border-slate-200 bg-slate-950 p-5 text-white shadow-[0_18px_40px_rgba(15,23,42,0.18)]">
            ...
            <p className="mt-3 text-4xl font-semibold">{postsCount}</p>
          ...
          <div className="rounded-[24px] border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <p className="mt-3 text-4xl font-semibold text-slate-950">{toolsCount}</p>
