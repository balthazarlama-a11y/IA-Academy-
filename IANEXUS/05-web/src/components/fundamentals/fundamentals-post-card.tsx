...
export default function FundamentalsPostCard({ post }: { post: FundamentalsPost }) {
  ...
  return (
    <Link
      href={`/blog/${post.slug}`}
      className="group rounded-xl border border-slate-200/80 bg-white p-4 shadow-[0_10px_28px_rgba(15,23,42,0.05)] transition duration-200 hover:-translate-y-0.5 hover:border-slate-300"
    >
