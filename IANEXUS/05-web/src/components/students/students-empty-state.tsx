...
export default function StudentsEmptyState({
  ...
  return (
    <div className="rounded-3xl border border-slate-200 bg-white px-6 py-14 text-center md:px-10">
      ...
      <p className="mx-auto mt-3 max-w-xl text-sm leading-relaxed text-slate-600 md:text-base">
        Prueba ampliando la búsqueda o activa la opción de freemium para descubrir más
