...
export function CreateToolForm({
  ...
  return (
    <form action={handleSubmit} className="grid grid-cols-1 gap-3 md:grid-cols-2">
      ...
      <textarea name="editorial_summary" rows={5} placeholder="Resumen editorial largo: qué es, para quién sirve, cuándo conviene usarla y sus límites." disabled={isPending} className="rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm leading-6 text-slate-900 outline-none disabled:opacity-50 md:col-span-2" />
