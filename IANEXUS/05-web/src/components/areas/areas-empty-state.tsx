  ...
  return (
    <div className="flex flex-col items-center justify-center rounded-2xl border border-slate-200 bg-white px-6 py-14 text-center shadow-[0_10px_24px_rgba(15,23,42,0.04)]">
      ...
      <h3 className="text-lg font-semibold text-slate-900">
        {hasFilters ? "Sin resultados con esta combinación" : "Sin herramientas todavía"}
      </h3>
      <p className="mt-2 max-w-sm text-sm text-slate-500">
        {hasFilters
          ? "Quita un filtro o amplía un área para descubrir más herramientas."
          : "Las herramientas por área aparecerán aquí a medida que sumemos nuevas curadurías."}
      </p>
      {hasFilters && onReset ? (
        <button
          type="button"
