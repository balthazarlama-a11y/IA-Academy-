  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-bold text-white/90">Usuarios</h2>
      ...
      >
        ...
        <p className="text-sm text-white/40 max-w-sm mx-auto">
          La gestión de usuarios estará disponible en la Fase 5. Aquí podrás
          ver, editar roles y administrar permisos.
        </p>
      </div>
    </div>
  );
