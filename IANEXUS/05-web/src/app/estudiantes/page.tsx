            ...
            <div className="grid gap-6 p-5 md:p-6 lg:grid-cols-[1.1fr_0.9fr] lg:items-end lg:p-8">
              <div>
                ...
                <p className="mt-4 max-w-3xl text-sm leading-relaxed text-slate-600 md:text-base">
                  ...
                  freemium y opciones que piden correo institucional. Menos ruido, mas utilidad.
                </p>
                ...
                <div className="mt-5 flex flex-wrap items-center gap-3">
                  ...
                  >
                    ...
                    Unirme al grupo de beneficios estudiantiles
                  </TrackedWhatsAppLink>
              ...
              <div className="grid gap-3 sm:grid-cols-3 lg:grid-cols-1 xl:grid-cols-3">
                ...
                <div className="rounded-xl border border-slate-200 bg-slate-50 p-4">
                  <p className="text-xs uppercase tracking-[0.14em] text-slate-500">Beneficio estudiantil</p>
                  <p className="mt-2 text-sm font-semibold text-slate-900">Correo institucional</p>
                  <p className="mt-1 text-sm leading-relaxed text-slate-600">
